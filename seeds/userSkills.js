  ...
  return knex('userSkills').del()
    .then(function () {
      return Promise.all([
        ...
        knex('userSkills').insert({id: 1096, user_id: 197, skill_id: 105, status: "attempted", showcaseURL: 'https://www.youtube.com/embed/J5_HmfZyhKo'}),
        ...
        knex('userSkills').insert({id: 1094, user_id: 197, skill_id: 107, status: "attempted", showcaseURL: 'https://www.youtube.com/embed/s9r-CxnCXkg'}),
        ...
        knex('userSkills').insert({id: 1092, user_id: 198, skill_id: 109, status: "attempted", showcaseURL: 'https://www.youtube.com/embed/s9r-CxnCXkg'}),
        ...
        knex('userSkills').insert({id: 1090, user_id: 198, skill_id: 1011, status: "attempted", showcaseURL: 'https://www.youtube.com/embed/s9r-CxnCXkg'}),
        ...
        knex('userSkills').insert({id: 1088, user_id: 198, skill_id: 1013, status: "attempted", showcaseURL: 'https://www.youtube.com/embed/s9r-CxnCXkg'}),
        ...
        knex('userSkills').insert({id: 1086, user_id: 199, skill_id: 1015, status: "attempted", showcaseURL: 'https://www.youtube.com/embed/s9r-CxnCXkg'})
